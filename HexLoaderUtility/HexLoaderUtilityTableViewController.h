...
*******************************************************************************/
//
//  HexLoaderUtilityTableViewController.h
//  HexLoaderUtility
//
...
@interface HexLoaderUtilityTableViewController : NSViewController <NSTableViewDataSource, NSFilePresenter>
@property (weak) IBOutlet NSTableView *tableView;

@property (nonatomic, strong) NSURL *tempFolderURL;
@property (nonatomic) BOOL tempFolderChanged;
